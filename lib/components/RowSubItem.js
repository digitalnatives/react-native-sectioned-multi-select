      ...
      >
        <TouchableOpacity
          ...
          style={[
            ...
            styles.subItem,
            customStyle.subRowItem,
            (this._itemSelected(item) || highlightChild) && customStyle.selectedSubRowItem
          ]}
        >
          <Text
            numberOfLines={numberOfLines}
            style={[
              { flex: 1, color: "black", paddingLeft: 40, fontSize: 18 },
              customStyle.subRowItemText
              ]}
          >
            {item.name}
          </Text>
